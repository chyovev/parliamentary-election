...
/**
 * Base class that represents a row from the 'parties' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Parties implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PartiesTableMap';
    ...
    /**
     * Initializes internal state of Base\Parties object.
     */
    ...
    /**
     * Compares this with another <code>Parties</code> instance.  If
     * <code>obj</code> is an instance of <code>Parties</code>, delegates to
     * <code>equals(Parties)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Parties The current object, for fluid interface
     */
     ...
     * @return $this|\Parties The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[PartiesTableMap::COL_ID] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[PartiesTableMap::COL_TITLE] = true;
        }
    ...
    public function setAbbreviation($v)
    {
        ...
        if ($this->abbreviation !== $v) {
            $this->abbreviation = $v;
            $this->modifiedColumns[PartiesTableMap::COL_ABBREVIATION] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[PartiesTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PartiesTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PartiesTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PartiesTableMap::translateFieldName('Abbreviation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->abbreviation = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PartiesTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = PartiesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Parties'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPartiesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Parties::setDeleted()
     * @see Parties::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPartiesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PartiesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[PartiesTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . PartiesTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(PartiesTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(PartiesTableMap::COL_TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'title';
        }
        if ($this->isColumnModified(PartiesTableMap::COL_ABBREVIATION)) {
            $modifiedColumns[':p' . $index++]  = 'abbreviation';
        }
        if ($this->isColumnModified(PartiesTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }

        $sql = sprintf(
            'INSERT INTO parties (%s) VALUES (%s)',
    ...
    {
        $pos = PartiesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Parties'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Parties'][$this->hashCode()] = true;
        $keys = PartiesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(PartiesTableMap::DATABASE_NAME);

        if ($this->isColumnModified(PartiesTableMap::COL_ID)) {
            $criteria->add(PartiesTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(PartiesTableMap::COL_TITLE)) {
            $criteria->add(PartiesTableMap::COL_TITLE, $this->title);
        }
        if ($this->isColumnModified(PartiesTableMap::COL_ABBREVIATION)) {
            $criteria->add(PartiesTableMap::COL_ABBREVIATION, $this->abbreviation);
        }
        if ($this->isColumnModified(PartiesTableMap::COL_CREATED_AT)) {
            $criteria->add(PartiesTableMap::COL_CREATED_AT, $this->created_at);
        }
    ...
    {
        $criteria = ChildPartiesQuery::create();
        $criteria->add(PartiesTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Parties (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Parties Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildParties is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildParties The current object (for fluent API support)
     */
    public function setElectionsPartiess(Collection $electionsPartiess, ConnectionInterface $con = null)
    {
        ...
        foreach ($electionsPartiessToDelete as $electionsPartiesRemoved) {
            $electionsPartiesRemoved->setParties(null);
        }
    ...
    protected function doAddElectionsParties(ChildElectionsParties $electionsParties)
    {
        ...
        $electionsParties->setParties($this);
    }
    ...
    public function removeElectionsParties(ChildElectionsParties $electionsParties)
    {
        if ($this->getElectionsPartiess()->contains($electionsParties)) {
            ...
            $electionsParties->setParties(null);
        }
     ...
     * @return ObjectCollection|ChildElectionsParties[] List of ChildElectionsParties objects
     */
    public function getElectionsPartiessJoinElections(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildElectionsPartiesQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(PartiesTableMap::DEFAULT_STRING_FORMAT);
    }
