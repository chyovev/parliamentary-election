...
abstract class Party implements ActiveRecordInterface
{
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[PartyTableMap::COL_TITLE] = true;
        }
    ...
    public function setAbbreviation($v)
    {
        ...
        if ($this->abbreviation !== $v) {
            $this->abbreviation = $v;
            $this->modifiedColumns[PartyTableMap::COL_ABBREVIATION] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[PartyTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PartyTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PartyTableMap::translateFieldName('Abbreviation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->abbreviation = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PartyTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = PartyTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PartyTableMap::COL_CREATED_AT)) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[PartyTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . PartyTableMap::COL_ID . ')');
        }
        ...
        if ($this->isColumnModified(PartyTableMap::COL_TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'title';
        }
        if ($this->isColumnModified(PartyTableMap::COL_ABBREVIATION)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PartyTableMap::COL_TITLE)) {
            $criteria->add(PartyTableMap::COL_TITLE, $this->title);
        }
        if ($this->isColumnModified(PartyTableMap::COL_ABBREVIATION)) {
            $criteria->add(PartyTableMap::COL_ABBREVIATION, $this->abbreviation);
        }
        if ($this->isColumnModified(PartyTableMap::COL_CREATED_AT)) {
            $criteria->add(PartyTableMap::COL_CREATED_AT, $this->created_at);
        }
    ...
    {
        $criteria = ChildPartyQuery::create();
        $criteria->add(PartyTableMap::COL_ID, $this->id);
     ...
     * If this ChildParty is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildParty The current object (for fluent API support)
     */
    public function setElectionParties(Collection $electionParties, ConnectionInterface $con = null)
    {
        ...
        foreach ($electionPartiesToDelete as $electionPartyRemoved) {
            $electionPartyRemoved->setParty(null);
        }
     ...
     * Otherwise if this Party is new, it will return
     * an empty collection; or if this Party has previously
     * been saved, it will retrieve related ElectionParties from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Party.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildElectionParty[] List of ChildElectionParty objects
     */
    public function getElectionPartiesJoinElection(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildElectionPartyQuery::create(null, $criteria);
